...
#define LUMINOSITE2   200      // Luminosité maximumum sachant que cela varie de 0 à 255
...
uint32_t COULEUR_BAS =  led.Color(30, 30, 30);
...
void loop() {
    ...
    for( int i = 0; i < NUM_LEDS; i++) {
        ...
        FastLED.show();
        delay(DELAI1);
        bright_current =  bright_current+(LUMINOSITE1/NUM_LEDS);
        if (bright_current>LUMINOSITE1-1) {
          bright_current=LUMINOSITE1;
        }
    }
    delay(DELAI2);
